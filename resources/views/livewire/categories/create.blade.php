<div class="p-6 lg:p-10 space-y-10 bg-pos-muted min-h-screen font-sans">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            ...
            <h1 class="text-3xl lg:text-4xl font-black text-pos-foreground tracking-tight">Tambah Kategori</h1>
            <p class="text-pos-secondary font-medium mt-1">Klasifikasikan produk Anda dengan kategori baru.</p>
        </div>
    </div>
            ...
            <form wire:submit.prevent="save" class="space-y-8">
                <!-- Field: Name -->
                 <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="text" wire:model.live="name" placeholder="Contoh: Coffee, Non-Coffee, Snack" class="w-full h-14 px-6 rounded-2xl bg-pos-muted dark:bg-pos-muted/10 border-none font-bold text-sm text-pos-foreground outline-none focus:ring-2 focus:ring-primary-blue/20">
                ...
                <div class="p-6 bg-pos-card-grey/50 dark:bg-pos-muted/10 rounded-3xl border border-pos-border dark:border-zinc-800 flex gap-4 items-start">
                    ...
                    <div class="pt-1">
                        <h6 class="text-xs font-black text-pos-foreground uppercase tracking-widest mb-1">Kegunaan Kategori</h6>
                        <p class="text-[11px] text-pos-secondary font-medium leading-relaxed">Kategori mempermudah kasir dalam mencari produk di layar POS dan memberikan laporan yang lebih terperinci.</p>
                    </div>
                </div>
